...
class DocumentReference1(BaseModel):
    """
...
class DocumentReference2(BaseModel):
    """
    Represents a reference to a clinical document or file associated with a patient, such as lab reports, imaging studies, discharge summaries, or invoices.
    """
    ...
    """
    data: Annotated[
        str, Field(examples=['JVBERi0xLjQKMSAwIG9iago8PAovVGl0bGUgKExhYiBS...'])
    ]
    """
    Base64-encoded content of the document. Use for inline embedding of small documents.
    """
...
class DocumentReference(RootModel[DocumentReference1 | DocumentReference2]):
    root: Annotated[
        DocumentReference1 | DocumentReference2, Field(title='DocumentReference')
    ]
    """
    Represents a reference to a clinical document or file associated with a patient, such as lab reports, imaging studies, discharge summaries, or invoices.
    """
