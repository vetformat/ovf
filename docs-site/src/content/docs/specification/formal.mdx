...
This page summarizes the key aspects of the OVF specification. The full specification is available in the [specification.md](https://github.com/vetnote/open-vet-format/blob/main/docs/specification.md) file in the repository.
...
The full list of all controlled vocabularies is in the [specification](https://github.com/vetnote/open-vet-format/blob/main/docs/specification.md#4-controlled-vocabularies).
