...
{/* Auto-generated from schemas/v1/observation.schema.json — do not edit manually */}
...
**Schema ID:** `https://open-vet-format.vetnote.app/schemas/v1/observation.schema.json`
...
```json
{
  ...
  "$id": "https://open-vet-format.vetnote.app/schemas/v1/observation.schema.json",
  "title": "Observation",
  "description": "Represents a clinical observation or measurement for a patient, including vital signs, lab results, imaging findings, and clinical notes.",
  "type": "object",
  "required": [
