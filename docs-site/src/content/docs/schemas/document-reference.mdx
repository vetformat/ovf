...
**Schema ID:** `https://open-vet-format.vetnote.app/schemas/v1/document-reference.schema.json`
...
```json
{
  ...
  "$id": "https://open-vet-format.vetnote.app/schemas/v1/document-reference.schema.json",
  "title": "DocumentReference",
  "description": "Represents a reference to a clinical document or file associated with a patient, such as lab reports, imaging studies, discharge summaries, or invoices.",
  "type": "object",
  "required": [
