...
description: "Root export schema for the VetNote Open Vet Format. Wraps all veterinary medical record resources for a single patient into a portable, interoperable document."
---

{/* Auto-generated from schemas/v1/ovf.schema.json — do not edit manually */}

Root export schema for the VetNote Open Vet Format. Wraps all veterinary medical record resources for a single patient into a portable, interoperable document.

**Schema ID:** `https://open-vet-format.vetnote.app/schemas/v1/ovf.schema.json`
...
```json
{
  ...
  "$id": "https://open-vet-format.vetnote.app/schemas/v1/ovf.schema.json",
  "title": "Open Vet Format (OVF)",
  "description": "Root export schema for the VetNote Open Vet Format. Wraps all veterinary medical record resources for a single patient into a portable, interoperable document.",
  "type": "object",
  "required": [
