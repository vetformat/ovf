...
{/* Auto-generated from schemas/v1/encounter.schema.json — do not edit manually */}

Represents a clinical encounter or visit between a patient and a veterinary practitioner.

**Schema ID:** `https://open-vet-format.vetnote.app/schemas/v1/encounter.schema.json`
...
| `clinic` | `string` | No | Name of the veterinary clinic or hospital. |
...
```json
{
  ...
  "$id": "https://open-vet-format.vetnote.app/schemas/v1/encounter.schema.json",
  "title": "Encounter",
  "description": "Represents a clinical encounter or visit between a patient and a veterinary practitioner.",
  "type": "object",
  "required": [
  ...
  "$defs": {
    ...
    "practitioner": {
      "type": "object",
      "description": "The veterinary practitioner involved in this encounter.",
      "properties": {
        "name": {
          "type": "string",
        ...
        "clinic": {
          "type": "string",
          "description": "Name of the veterinary clinic or hospital.",
          "examples": [
