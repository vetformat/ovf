...
{/* Auto-generated from schemas/v1/patient.schema.json — do not edit manually */}

Represents an animal patient in a veterinary practice. Contains demographic, identification, and owner information.

**Schema ID:** `https://open-vet-format.vetnote.app/schemas/v1/patient.schema.json`
...
```json
{
  ...
  "$id": "https://open-vet-format.vetnote.app/schemas/v1/patient.schema.json",
  "title": "Patient",
  "description": "Represents an animal patient in a veterinary practice. Contains demographic, identification, and owner information.",
  "type": "object",
  "required": [
