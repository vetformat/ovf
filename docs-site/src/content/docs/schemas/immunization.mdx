...
**Schema ID:** `https://open-vet-format.vetnote.app/schemas/v1/immunization.schema.json`
...
```json
{
  ...
  "$id": "https://open-vet-format.vetnote.app/schemas/v1/immunization.schema.json",
  "title": "Immunization",
  "description": "Represents a vaccination event for an animal patient, including vaccine details, dosage, and scheduling information.",
  "type": "object",
  "required": [
  ...
  "$defs": {
    ...
    "practitioner": {
      "type": "object",
      "description": "The veterinary practitioner who administered the vaccination.",
      "properties": {
        "name": {
          "type": "string",
